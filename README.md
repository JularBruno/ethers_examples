...
- [Ethers.js API Documentation](https://docs.ethers.org/v5/api/)
- [YouTube Video](https://www.youtube.com/watch?v=yk7nVp5HTCk)
- [Infura](https://app.infura.io/)
- [Chainlink Faucet](https://faucets.chain.link/)
- [Sepolia Etherscan](https://sepolia.etherscan.io/)
- [Etherscan](https://etherscan.io/)
- [Chainlink LINK Token Contracts](https://docs.chain.link/resources/link-token-contracts?parent=chainlinkFunctions)
- [DAI Token on Etherscan](https://etherscan.io/token/0x6b175474e89094c44da98b954eedeac495271d0f)
